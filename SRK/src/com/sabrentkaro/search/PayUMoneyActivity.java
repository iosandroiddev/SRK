...
public class PayUMoneyActivity extends BaseActivity {
	...
	Context activity;
	/**
	 * Order Id To Request for Updating Payment Status if Payment Successfully
	 * Done
	 */
	...
	// Test Variables
	/*
	 * private String mMerchantKey = "FCyqqZ"; private String mSalt =
	 * "sfBpGA8E"; private String mBaseURL = "https://test.payu.in";
	 */

	// Final Variables
	private String mMerchantKey = ":payutest@payu.in";
	...
	private String mFirstName = "Manohar"; // From Previous Activity
	private String mEmailId = "perepamanohar@gmail.com"; // From Previous
															// Activity
	private double mAmount = 200; // From Previous Activity
	private String mPhone = "9885958967"; // From Previous Activity
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.i("Info: ", "" + mFirstName + " : " + mEmailId + " : " + mAmount
				+ " : " + mPhone);
		...
		webView.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedError(WebView view,
				...
				Toast.makeText(activity, "Oh no! " + error, Toast.LENGTH_SHORT)
						.show();
			}
			...
			public void onReceivedSslError(WebView view,
				...
				Toast.makeText(activity, "SSL Error! " + error,
		...
		webView.addJavascriptInterface(new PayUJavaScriptInterface(
				PayUMoneyActivity.this), "PayUMoney");
